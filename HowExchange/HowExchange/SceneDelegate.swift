...
extension SceneDelegate {
    private func setRootViewController(_ scene: UIScene) {
        if Storage.isFirstTime() {
            setRootViewController(scene, name: "Onboarding", identifier: "OnboardingNavigationController")
        } else {
            setRootViewController(scene, name: "Main", identifier: "MainNavigationController")
        }
    }
